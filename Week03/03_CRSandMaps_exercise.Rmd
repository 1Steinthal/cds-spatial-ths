...
What can you say about the content of each file?
  ...
  - What type of data does it store? places_sf stores points in Aarhus, stores 'dybdevandsboringer for nitrat in Denmark
  - How many attributes does it contain? places_ has 3-4, nitrates has 20
  - What is its geometry? (points, lines, polygons, surfaces, network)? places_sf has points, also nitrates
  - What kind of coordinate system does it use? Places is latlong, nitrat is northing easting

* Display the `elevation` object and view its structure.
What can you say about the content of this file? 

  - What type of data does it store? It looks like geoJson
  - What is the coordinate system used?  LongLat WGS84
  - How many attributes does it contain? Quite a lot
  - How many dimensions does it have? 396 x 876
  - What is the data resolution? 0.008333 x 0.008333
  
* Can you plot the files on top of one another? Why? Well, right now their reference system are a mess. We need to fix that! 
