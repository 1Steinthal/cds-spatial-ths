...
df_df <- st_transform(df_sf, crs = 25832)
...
municipalities_25832 <- st_transform(municipalities, crs = 25832)
...
plot(st_geometry(shelters), pch = 16 ,add = TRUE)
...
plot(st_geometry(municipalities_25832), col = "grey", border = "white")
plot(shelters, add = T, pch = 1, col = "forestgreen")
...
all.equal(crs(shelters),crs(municipalities_25832))
